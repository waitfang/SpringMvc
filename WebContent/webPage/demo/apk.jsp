...
<body>
	...
	<div style="margin-top:100px;margin-left:10%;"> 
		<table>
			...
			<td>
				<fieldset style="height:370px;">
					...
					<table style="border-collapse:separate; border-spacing:30px;"> 
						<tr >
							<td>密钥 Name:</td>
							<td> <input type="file" id=key0jks></td>
						</tr>
						<tr>
							<td>keyAlias:</td>
							<td> <input type="text" id="keyAlias"  value="key0" style="height:50px;width:250px;"></td>
						</tr>
						<tr>
							<td>keypass:</td>
			...
			<td>
			 	<fieldset style="height:370px;margin-left:15%;width:100%;">
			    	<legend>打包新的APK,Versions:签名的信息，file：apk目录。</legend> 
			  
					<table style="border-collapse:separate; border-spacing:30px;"> 
						<tr >
							<td>ServerAPK Path:</td>
							<td> <input type="text" id="ServerAPKPath" Value="D:\apk" style="height:50px;width:250px;"></td>
						</tr>
						<tr >
							<td>APK Name:</td>
							<td> <input type="file" id="APKPath"></td>
						</tr>
						<tr>
							<td>Versions:</td>
		...
		<div id="progressbar" style="float:left;border:1px solid #00F;width:85%;"></div> 
		<br/>
		<input type="text" id="newAppPath" value="新APK存放目录" style="height:50px;width:84%;margin-left:0.3%;">  
	</div>
